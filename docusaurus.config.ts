...
const config: Config = {
  ...
  future: { v4: true, faster: { swcJsLoader: true, swcJsMinimizer: true, swcHtmlMinimizer: true, lightningCssMinimizer: true, rspackBundler: true, rspackPersistentCache: false, mdxCrossCompilerCache: true, ssgWorkerThreads: true } },
  // The two blog instances emit their own feed <link>s. The study feed is generated by
  // scripts/generate.mjs into static/, so its discovery tags have to be declared here.
  headTags: [
    { tagName: "link", attributes: { rel: "alternate", type: "application/rss+xml", href: "/cyberjudah/study/rss.xml", title: "CyberJudah \u00b7 4 Chapters a Day RSS Feed" } },
    { tagName: "link", attributes: { rel: "alternate", type: "application/json", href: "/cyberjudah/study/feed.json", title: "CyberJudah \u00b7 4 Chapters a Day JSON Feed" } },
  ],
