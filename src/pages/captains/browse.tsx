...
type Episode = { title: string; url: string; date: string; year: string; thumb: string; books: string[] };
      ...
      <main className="cj-browse">
        <div className="cj-browse-inner">
          <header className="cj-browse-head">
            ...
            <p>
              Short teachings from the captains, written up in full. Find one by name, or narrow to a year.
