...
const GROUPS: NavGroup[] = [
  {
    label: "Teaching",
    items: [
      { to: "/teachings", label: "Search Teachings", blurb: "Find transcript passages and open the recording where they were spoken." },
      ...
      <div className="cj-wrap cj-footer__grid">
        ...
        <div>
          ...
          <ul>
            ...
            <li><Link to="/truth-shall-make-you-free">The Truth Shall Make You Free</Link></li>
