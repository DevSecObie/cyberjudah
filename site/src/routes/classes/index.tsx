...
export const Route = createFileRoute("/classes/")({
  loader: () => api.classes(),
  head: () => ({ meta: [{ title: "Sabbath Classes · CyberJudah" }, { name: "description", content: "Every Sabbath class written up in full, scriptures cited inline." }] }),
  component: Browse,
});
...
function Browse() {
  ...
  return (
    <Page>
      ...
      <p className="cj-lede">Every class written up in full, in the teacher's own words, with the scriptures cited inline. Narrow by the book it opens or by who taught it.</p>
