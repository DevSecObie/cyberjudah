...
export const Route = createFileRoute("/study/")({
  ...
  head: () => ({ meta: [{ title: "4 Chapters a Day · CyberJudah" }, { name: "description", content: "Notes from the daily reading, one page per chapter, every verse taught quoted in place." }] }),
