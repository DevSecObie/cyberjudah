 ...
 * push-in, cut into four segments at exact frames, so the four chapters scrub back to back
...
export const scrollScrubScenes: ScrollScrubScene[] = [
  {
    ...
    actions: createElement(LampButton, { to: "/bible" }, "Open the Bible"),
  ...
  },
  {
    ...
    actions: createElement(ReadLink, { to: "/bible/genesis/1" }, "Start at Genesis 1"),
  ...
  },
  {
    ...
    actions: createElement(ReadLink, { to: "/classes" }, "Browse the classes"),
  ...
  },
  {
    ...
    actions: createElement(ReadLink, { to: "/cases" }, "Read the cases"),
